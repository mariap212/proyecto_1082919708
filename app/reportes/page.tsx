...
export const metadata: Metadata = {
  title: 'Reportes | OvoGest',
  description: 'Reportes y métricas de OvoGest',
};
      ...
      <div className="relative mx-auto w-full max-w-6xl">
        ...
        <section className="glass-card relative overflow-hidden rounded-[2rem] border border-white/10 bg-slate-950/90 p-8 shadow-2xl shadow-slate-950/30">
          <div className="space-y-8">
            <div>
              <p className="text-sm uppercase tracking-[0.24em] text-violet-300 font-semibold">Reportes</p>
              <h1 className="mt-4 text-4xl font-semibold text-white sm:text-5xl">Análisis y métricas</h1>
              <p className="mt-4 text-slate-300 max-w-3xl leading-7">
                Accede a los reportes de ventas, ingresos y desempeño para tu distribuidora mayorista.
              </p>
            </div>
            ...
            <div className="grid gap-6 sm:grid-cols-2">
              <div className="rounded-[1.75rem] border border-white/10 bg-slate-900/80 p-6 shadow-lg shadow-slate-950/20">
                ...
                <p className="mt-4 text-white font-semibold">Sección de reportes en construcción</p>
                <p className="mt-3 text-slate-400">Pronto tendrás gráficos y datos para tomar decisiones más rápidas.</p>
              </div>
              <div className="rounded-[1.75rem] border border-white/10 bg-slate-900/80 p-6 shadow-lg shadow-slate-950/20">
                <p className="text-sm uppercase tracking-[0.2em] text-slate-400">Próximos pasos</p>
                <ul className="mt-4 list-disc space-y-2 pl-5 text-slate-300">
                  <li>Ventas por periodo</li>
                  <li>Margen e ingresos</li>
                  <li>Comparativo mensual</li>
                </ul>
              </div>
            </div>
          </div>
